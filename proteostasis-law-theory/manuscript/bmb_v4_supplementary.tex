...
\noindent This document accompanies the paper above. Every number in the caption is recomputed by the script named in it and asserted by the accompanying test suite.
